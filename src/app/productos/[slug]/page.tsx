        ...
        <div className="relative aspect-square bg-white rounded-2xl overflow-hidden">
          {product.images[0] ? (
            <Image
              ...
              fill
              className={`object-contain ${product.slug === "marvis-classic-strong-mint" ? "p-[20%]" : product.slug === "logitech-mx-master-4" ? "p-[20%]" : product.slug === "fujifilm-x100vi" ? "p-[15%]" : product.slug === "apple-airpods-pro-3" ? "p-[20%]" : product.slug === "alessi-tetera-9093" ? "p-[15%]" : product.slug === "stanley-termo-cafe-go" ? "p-[20%]" : "p-10"}`}
              priority
